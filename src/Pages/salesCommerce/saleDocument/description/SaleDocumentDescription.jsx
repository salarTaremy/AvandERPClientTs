...
const SaleDocumentDescription = (props) => {
    const { id } = props;
    const [saleDocumentData, saleDocumentLoading, saleDocumentError] = api.useFetch(`${url.SALE_DOCUMENT_HEADER}/${id}`);
    ...
    return (
        <>
            <SaleDocumentHeaderInfo id={id} saleDocumentData={saleDocumentFetchedData} loading={saleDocumentLoading} className="pb-5"/>
            <SaleDocumentDetail saleDocumentHeaderId={id}/>
            <SaleDocumentFooterInfo id={id} saleDocumentData={saleDocumentFetchedData} loading={saleDocumentLoading} className="pt-5"/>
        </>
    )
}
